...
class MainViewController: UITableViewController, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        datePicker.addTarget(self, action: #selector(MainViewController.datePickerValueChanged(_:)), forControlEvents: .ValueChanged)
...
extension MainViewController: CameraOverlayViewDelegate {
...
extension MainViewController: G8TesseractDelegate {
